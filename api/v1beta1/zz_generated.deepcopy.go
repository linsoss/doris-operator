...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DorisInitializerRecStageStatus) DeepCopyInto(out *DorisInitializerRecStageStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DorisInitializerRecStageStatus.
func (in *DorisInitializerRecStageStatus) DeepCopy() *DorisInitializerRecStageStatus {
	if in == nil {
		return nil
	}
	out := new(DorisInitializerRecStageStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DorisInitializerStatus) DeepCopyInto(out *DorisInitializerStatus) {
	*out = *in
	if in.PrevSpecHash != nil {
		in, out := &in.PrevSpecHash, &out.PrevSpecHash
		*out = new(string)
		**out = **in
	}
